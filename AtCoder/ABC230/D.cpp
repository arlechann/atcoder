...
class IntervalScheduling {
	...
	public:
	IntervalScheduling(std::vector<Interval<T>> intervals, T d)
...
int main() {
	...
	vector<Interval<ll>> intervals(n);
	REP(i, n) { intervals[i] = Interval<ll>(l[i], r[i]); }

	IntervalScheduling<ll> s(intervals, d);
