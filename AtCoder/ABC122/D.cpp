...
int main() {
	...
	auto dp = make_vector({n + 1, 4, 4, 4}, mint(0));
	REP(i, n) {
		REP(j1, 4) {
			REP(j2, 4) {
				REP(j3, 4) {
					if(i < 2) {
						...
						if(j1 == A && j2 == G && j3 == C) {
							dp[i + 1][j1][j2][j3] = 0;
						} else if(j1 == G && j2 == A && j3 == C) {
							dp[i + 1][j1][j2][j3] = 0;
						} else if(j1 == A && j2 == C && j3 == G) {
							dp[i + 1][j1][j2][j3] = 0;
						} else {
							dp[i + 1][j1][j2][j3] = 1;
						}
						...
						if(j1 == A && j2 == G && j3 == C) {
							...
							dp[i + 1][j1][j2][j3] =
								dp[i][A][j1][j2] + dp[i][C][j1][j2] +
								dp[i][G][j1][j2] + dp[i][T][j1][j2];
						}
					}
				}
			}
