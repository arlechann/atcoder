...
mod solve {
	...
	impl Solver {
		...
		pub fn solve(&self) -> f64 {
			let ng = (self.b + 100) as f64 / self.a as f64 + 1.0;
			let result = bin_search(0.0, ng, |t| {
				return self.a as f64 * t
					+ self.b as f64 * (self.c as f64 * t * std::f64::consts::PI).sin()
					<= 100.0;
			});
			result
		}
