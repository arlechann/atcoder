...
int main() {
	...
	REP(i, n) {
		REP(j, i) {
			ll cost = mod_pow(a[i], a[j], m) + mod_pow(a[j], a[i], m);
			cost %= m;
 ...
 * 4 2 3 2
 *
 * 1-2 => (4^2 + 2^4) mod 10 = (16 + 16) mod 10 = 2
 * 1-3 => (4^2 + 3^4) mod 10 = (16 + 81) mod 10 = 7
 * 1-4 => (4^2 + 2^4) mod 10 = (16 + 16) mod 10 = 2
 *
 * 2-3 => (2^3 + 3^2) mod 10 = (8 + 9) mod 10 = 7
 * 2-4 => (2^2 + 2^2) mod 10 = (4 + 4) mod 10 = 8
 *
 * 3-4 => (3^2 + 2^3) mod 10 = (9 + 8) mod 10 = 7
 *
 * 1-3
 * 3-4
 * 2-4
