...
mod solve {
	...
	impl Solver {
		...
		pub fn solve(&self) -> String {
			vec![
				if self.a > max(self.b, self.c) {
					1
				} else if self.a < min(self.b, self.c) {
					3
				} else {
					2
				},
				if self.b > max(self.a, self.c) {
					1
				} else if self.b < min(self.a, self.c) {
					3
				} else {
					2
				},
				if self.c > max(self.a, self.b) {
					1
				} else if self.c < min(self.a, self.b) {
					3
				} else {
					2
				},
