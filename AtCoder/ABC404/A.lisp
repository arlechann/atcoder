...
(defun main ()
  (input* ((s string))
    (let ((a (make-array (1+ (- (char-to-index #\z) (char-to-index #\a))) :initial-element nil)))
      (map nil
           #'(lambda (c) (setf (aref a (char-to-index c)) t))
           s)
      (println (index-to-lower (position nil a))))))

(defun test ()
  (test-case "a" "b")
  (test-case "abcdfhijklmnopqrstuvwxyz" "e")
  (test-case "qazplwsxokmedcijnrfvuhbgt" "y")
  )
